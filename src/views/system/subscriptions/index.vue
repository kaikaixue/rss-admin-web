<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="订阅源id" prop="feedId">
        <el-input
          v-model="queryParams.feedId"
          placeholder="请输入订阅源id"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item label="订阅创建时间" prop="createdAt">
        <el-date-picker clearable
          v-model="queryParams.createdAt"
          type="date"
          value-format="yyyy-MM-dd"
          placeholder="请选择订阅创建时间">
        </el-date-picker>
      </el-form-item>
      <el-form-item label="订阅更新时间" prop="updatedAt">
        <el-date-picker clearable
          v-model="queryParams.updatedAt"
          type="date"
          value-format="yyyy-MM-dd"
          placeholder="请选择订阅更新时间">
        </el-date-picker>
      </el-form-item>
      <el-form-item>
    ...
    <el-table v-loading="loading" :data="subscriptionsList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="订阅创建时间" align="center" prop="createdAt" width="180">
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.createdAt, '{y}-{m}-{d}') }}</span>
        </template>
      </el-table-column>
      <el-table-column label="订阅更新时间" align="center" prop="updatedAt" width="180">
        <template slot-scope="scope">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="订阅源id" prop="feedId">
          <el-input v-model="form.feedId" placeholder="请输入订阅源id" />
        </el-form-item>
        <el-form-item label="订阅创建时间" prop="createdAt">
          <el-date-picker clearable
...
export default {
  ...
  methods: {
    ...
    handleUpdate(row) {
      ...
      getSubscriptions(subscriptionId).then(response => {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除订阅关系编号为"' + subscriptionIds + '"的数据项？').then(function() {
        return delSubscriptions(subscriptionIds);
      }).then(() => {
        this.getList();
